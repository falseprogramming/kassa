...
class Bootstrap 
{
    ...
    public function setPathRoot($path)
    {
         ...
         */
        $this->_pathController = $this->_pathRoot . 'application/controller/';
        $this->_pathModel = $this->_pathRoot . 'application/model/';
        $this->_pathView = $this->_pathRoot . 'application/view/';
